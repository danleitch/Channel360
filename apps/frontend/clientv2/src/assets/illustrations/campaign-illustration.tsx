  ...
  return (
    ...
    >
      <svg viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="10.04" y="33.8052" width="23.28" height="4.85" rx="2.425" fill={PRIMARY_LIGHTER} />
        <rect x="10.04" y="25.0752" width="34.92" height="4.85" rx="2.425" fill={PRIMARY_DARKER} />
      </svg>
    </Box>
  );
}
