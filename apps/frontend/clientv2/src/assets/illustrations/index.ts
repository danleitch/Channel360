...
export { default as CampaignIllustration } from './campaign-illustration';
export { default as TemplateIllustration } from './template-illustration';
...
export { default as SubscriberIllustration } from './subscriber-illustration';
