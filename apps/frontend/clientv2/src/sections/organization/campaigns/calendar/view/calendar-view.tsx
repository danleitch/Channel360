...
import CalendarEdit from '../calendar-edit-form';
...
export default function CalendarView() {
  ...
  const currentEditEvent = useEvent(events, selectEventId, selectedRange, openEditForm);
  ...
  return (
    <>
      ...
      >
        <DialogTitle sx={{ minHeight: 76 }}>New Campaign</DialogTitle>
      ...
      >
        <DialogTitle sx={{ minHeight: 76 }}>Edit Campaign</DialogTitle>
