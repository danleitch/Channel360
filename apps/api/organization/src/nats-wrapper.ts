import { connect, JetStreamClient, NatsConnection, RetentionPolicy, StreamConfig } from "nats";
  ...
  async connect(
    ...
    if (this._client)
      if (connected) {
        ...
        const organizationStream: StreamConfig = {
        ...
        const settingsStream: StreamConfig = {
          ...defaultStreamConfiguration,
          retention: RetentionPolicy.Interest,
          name: "SETTINGS",
        ...
        const APIKeyStream: StreamConfig = {
          ...defaultStreamConfiguration,
          retention: RetentionPolicy.Interest,
          name: "APIKEY",
        ...
        // <!--- End Configure Streams --->

        if (typeof jsm == "object" && jsm.hasOwnProperty("streams")) {
          await jsm.streams
            .add(organizationStream)
            .catch((e) => console.log(e));
          await jsm.streams.add(settingsStream).catch((e) => console.log(e));
          await jsm.streams.add(APIKeyStream).catch((e) => console.log(e));
        }
