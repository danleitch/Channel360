...
describe("Sending a video 📹 in a campaign", () => {
  it("Sends a Video in the header", async () => {
      ...
      expect.arrayContaining([
        expect.objectContaining({
          ...
          parameters: expect.arrayContaining([
            expect.objectContaining({
              video: {
                link: "https://channel360-template-tags.s3.af-south-1.amazonaws.com/2024-02-08T14%3A21%3A52.234Z-TEST%20VIDEO.mp4",
              },
              type: "video",
            }),
          ]),
