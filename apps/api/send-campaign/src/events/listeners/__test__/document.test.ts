...
describe("Sending a document tag in a campaign", () => {
  it("Sends a Document in the header", async () => {
        ...
        head: [
          {
            type: "document",
            document: {
              link: "https://channel360-template-tags.s3.af-south-1.amazonaws.com/2023-03-06T12%3A14%3A44.177Z-NFMWNotice%20of%20Retirement.pdf",
