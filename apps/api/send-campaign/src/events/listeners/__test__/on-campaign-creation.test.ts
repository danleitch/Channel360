...
describe("Sending a on-campaign-creation tag  in a campaign", () => {
  it("Sends a on-campaign-creation tag in the body and buttons", async () => {
    ...
    const campaign = Campaigns.build({
      ...
      tags: {
        head: [],
        body: [
          { index: 1, type: "on-campaign-creation", value: "Ultra" },
          {
            index: 2,
        ...
        buttons: [
          {  type: "on-campaign-creation", value: "123" },
        ],
      },
    });
